...
import {MonsterRequest} from "../structs/IMonsterApi";
...
export const useMonsterStore = defineStore({
    ...
    actions: {
        async fetchMonsterById(id: number): Promise<void> {
            ...
            console.log(import.meta.env.VITE_APP_MONSTER_API)
            // return await new Promise(r => setTimeout(r, 2000));
            return await axios.get(import.meta.env.VITE_APP_MONSTER_API + id.toString()).then((response) => {
